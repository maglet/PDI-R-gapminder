...
####Subsetting
Especially with large data sets, sometimes you need to assess a part of the data
rather than the whole. Depending on what you want to do, you'll either want to
work with a subset of rows or columns. Let's look at both
...
Now you should see a new variable in your clobal environment with 720 elements. 
...
* note the use of "==" in the Boolean expression. This is an example of a 
logical operator.
